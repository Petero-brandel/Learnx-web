...
export function CoursePreview() {
 ...
 className="group flex flex-col h-full rounded-2xl border border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-950 overflow-hidden hover:shadow-sm hover:border-zinc-300 dark:hover:border-zinc-700 transition-all duration-300"
 >
 {/* Card thumbnail */}
