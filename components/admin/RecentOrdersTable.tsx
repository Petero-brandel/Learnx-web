      ...
      {hasMore && (
        <div className="flex justify-center pt-2">
          <button 
            ...
            className="flex items-center gap-1.5 px-4 py-2 text-sm font-medium text-zinc-400 hover:text-zinc-200 bg-zinc-800/30 hover:bg-zinc-800/50 rounded-lg transition-colors border border-zinc-800/60"
          >
            Show More
