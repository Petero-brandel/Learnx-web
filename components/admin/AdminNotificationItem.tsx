...
const typeConfig: Record<string, { icon: React.ElementType; color: string; bg: string }> = {
 ...
 enrollment: { icon: BookOpen, color: 'text-amber-600 dark:text-amber-400', bg: 'bg-amber-100 dark:bg-amber-500/10' },
 ...
 broadcast: { icon: Megaphone, color: 'text-blue-600 dark:text-blue-400', bg: 'bg-blue-100 dark:bg-blue-500/10' },
}
