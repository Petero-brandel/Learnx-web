...
export function AuthDialog({ variant, mode }: AuthDialogProps) {
  ...
  const Card = (
    <div
      className="w-full max-w-[480px] relative rounded-[28px] border border-zinc-200/80 dark:border-zinc-800 bg-white/95 dark:bg-zinc-950/95 shadow-[0_30px_120px_rgba(0,0,0,0.24)] backdrop-blur-2xl p-6 sm:p-8"
