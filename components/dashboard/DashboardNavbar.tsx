...
export default function DashboardNavbar() {
  ...
  return (
    <nav className="fixed top-0 z-50 w-full bg-white/80 dark:bg-black/80 backdrop-blur-xl border-b border-zinc-200 dark:border-zinc-800 shadow-sm hidden md:block">
        ...
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            ...
            >
              ...
              {avatarOpen && (
                <div
                  className="absolute right-0 top-full mt-2 w-72 bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 shadow-2xl rounded-xl overflow-hidden animate-in fade-in slide-in-from-top-2 duration-200 z-50"
                  onMouseEnter={handleAvatarEnter}
                  onMouseLeave={handleAvatarLeave}
                >
                  {/* User info */}
      ...
      {activeMenu && dashboardMenus[activeMenu] && (
        ...
        >
          ...
          <div className="bg-white/95 dark:bg-zinc-950/95 backdrop-blur-2xl border-b border-zinc-200 dark:border-zinc-800 shadow-2xl">
            <div className="mx-auto w-[90%] max-w-7xl py-6 animate-in fade-in slide-in-from-top-2 duration-300">
              ...
              <div className="space-y-1">
                {dashboardMenus[activeMenu].items.map((item, i) => (
                  ...
                  >
                    <div className="flex-shrink-0 h-10 w-10 rounded-xl flex items-center justify-center transition-all duration-200 bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400 group-hover:bg-indigo-100 dark:group-hover:bg-indigo-900/40 group-hover:scale-110">
              ...
              {recentNotifs.length > 0 ? (
                <div className="space-y-1">
                  {recentNotifs.map((notif) => (
                    ...
                    >
                      <div className="flex-shrink-0 h-10 w-10 rounded-xl flex items-center justify-center bg-indigo-50 dark:bg-indigo-900/20 text-indigo-600 dark:text-indigo-400">
