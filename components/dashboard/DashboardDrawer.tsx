...
export default function DashboardDrawer({ isOpen, onClose }: DashboardDrawerProps) {
 ...
 <div className="h-12 w-12 rounded-full bg-blue-100 dark:bg-blue-900/30 flex items-center justify-center ring-2 ring-blue-200 dark:ring-blue-800">
...
"text-zinc-700 dark:text-zinc-300 hover:bg-zinc-50 dark:hover:bg-zinc-900",
 pathname === item.href &&"bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 font-semibold"
)}
 >
 <div className="flex items-center gap-3">
