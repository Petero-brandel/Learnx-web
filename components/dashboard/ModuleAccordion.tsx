...
"h-5 w-5 text-zinc-500 dark:text-zinc-400 flex-shrink-0 transition-transform duration-200 ml-2",
 open &&"rotate-180"
)} />
 </button>
 ...
 className={cn(
"group flex items-center gap-3 w-full px-4 py-3 text-left transition-all duration-150",
"hover:bg-zinc-50 dark:hover:bg-zinc-900/50",
"border-l-2",
 isActive
 ?"border-l-blue-600 dark:border-l-blue-400 bg-blue-50/50 dark:bg-blue-900/10"
