            ...
            <div>
              ...
              {thumbnailPreview ? (
                ...
                <button
                  ...
                  className="w-full h-44 border-2 border-dashed border-zinc-800 hover:border-indigo-500/40 rounded-xl flex flex-col items-center justify-center gap-2 transition-colors cursor-pointer bg-zinc-900/30 hover:bg-indigo-500/5"
                >
