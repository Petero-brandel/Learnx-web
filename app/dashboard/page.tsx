...
function DashboardContent() {
  ...
  if (loading || verifying) {
    return (
      <div className="space-y-4">
        {verifying && (
          <div className="bg-indigo-50 dark:bg-indigo-500/10 border border-indigo-200 dark:border-indigo-500/20 rounded-xl p-4 flex items-center justify-center gap-3 text-indigo-700 dark:text-indigo-300">
            <div className="h-5 w-5 border-2 border-indigo-600 dark:border-indigo-400 border-t-transparent rounded-full animate-spin" />
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex gap-3 overflow-x-auto pb-2 snap-x snap-mandatory scrollbar-hide md:grid md:grid-cols-3 md:overflow-visible md:pb-0">
        <StatsCard
          icon={BookOpen}
