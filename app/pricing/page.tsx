...
export default function PricingPage() {
 ...
 plan.popular
 ? 'bg-zinc-900 dark:bg-white text-white dark:text-zinc-900 border-2 border-blue-500 shadow-xl shadow-blue-500/10 scale-105 z-10'
 : 'bg-white dark:bg-zinc-950/50 border border-zinc-200 dark:border-zinc-800/80 text-zinc-900 dark:text-zinc-100'
 }`}
 >
 {plan.popular && (
 <div className="absolute -top-4 left-1/2 -translate-x-1/2 px-4 py-1 bg-blue-600 text-white text-xs font-bold uppercase tracking-widest rounded-full">
 Most Popular
 </div>
)}
 ...
 <Check className={`h-5 w-5 flex-shrink-0 ${plan.popular ? 'text-blue-400 dark:text-blue-600' : 'text-blue-600 dark:text-blue-400'}`} />
