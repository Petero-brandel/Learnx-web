...
export default function PrivacyPage() {
 ...
 <p className="mb-6">At Bluedemy, we take your privacy seriously. This Privacy Policy explains how we collect, use, disclose, and safeguard your information when you visit our website and use our platform.</p>
 ...
 <p className="mb-6">Bluedemy may collect and use Users personal information for the following purposes:</p>
